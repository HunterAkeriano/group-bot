...
const MODE_CONFIG = {
    ...
    task: {
        ...
        postPrompt: (text) => `Створи коротку практичну задачу з JavaScript українською. Тема: "${text}". Формат: 🧩 Задача: опис, 🔍 Уточнення: умови. До 1000 символів.`,
    ...
    quote: {
        topicsPrompt: (num) => `Придумай ${num}, дотепних цитат українською про життя або філософію розробника/айтішника. Кожна цитата: від 30 до 100 символів, без лапок, почни з емодзі. Формат: 1) емодзі + цитата ...`,
