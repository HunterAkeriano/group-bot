...
const MODE_CONFIG = {
    ...
    quote: {
        topicsPrompt: (num) => `Придумай ${num}, дотепних цитат українською про життя або філософію розробника/айтішника. Кожна цитата: від 10 до 100 символів, без лапок, почни з емодзі. Формат: 1) емодзі + цитата ...`,
